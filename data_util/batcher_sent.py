...
# from pointer_LSTM import data_util as config, data_util as data
...
class Batcher(object):
  ...
  def __init__(self, data_path, vocab, mode, batch_size, single_pass):
    ...
    for _ in range(self._num_example_q_threads):
      # print("decode", self._num_example_q_threads)  decode:1 train:16
  ...
  def fill_example_queue(self):
    ...
    while True:
      try:
        ...
        article, abstract = article.decode(), abstract.decode()   #article,abstract  bytes---->str
